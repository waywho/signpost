...
ActiveRecord::Schema[8.1].define(version: 2026_05_27_080803) do
  ...
  create_table "git_hub_activities", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "watched_repos", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["full_name"], name: "index_watched_repos_on_full_name", unique: true
  end
